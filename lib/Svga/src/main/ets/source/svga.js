    ...
    com.opensource = (function() {
        ...
        opensource.svga = (function() {
            ...
            svga.AudioEntity = (function() {
                 ...
                 * @constructor
                 * @param {com.opensource.svga.IAudioEntity=} [properties] Properties to set
                 */
                function AudioEntity(properties) {
                    if (properties)
                        for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                            if (properties[keys[i]] != null)
                                this[keys[i]] = properties[keys[i]];
                 ...
                 * @static
                 * @param {com.opensource.svga.IAudioEntity=} [properties] Properties to set
                 * @returns {com.opensource.svga.AudioEntity} AudioEntity instance
                 */
                AudioEntity.create = function create(properties) {
                    return new AudioEntity(properties);
                };
                 ...
                 * @memberof com.opensource.svga.AudioEntity
                 * @static
                 * @param {com.opensource.svga.IAudioEntity} message AudioEntity message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                AudioEntity.encode = function encode(message, writer) {
                    if (!writer)
                        writer = $Writer.create();
                    if (message.audioKey != null && Object.hasOwnProperty.call(message, "audioKey"))
                        writer.uint32(/* id 1, wireType 2 =*/10).string(message.audioKey);
                    if (message.startFrame != null && Object.hasOwnProperty.call(message, "startFrame"))
                        writer.uint32(/* id 2, wireType 0 =*/16).int32(message.startFrame);
                    if (message.endFrame != null && Object.hasOwnProperty.call(message, "endFrame"))
                        writer.uint32(/* id 3, wireType 0 =*/24).int32(message.endFrame);
                    ...
                    if (message.totalTime != null && Object.hasOwnProperty.call(message, "totalTime"))
                        writer.uint32(/* id 5, wireType 0 =*/40).int32(message.totalTime);
                    return writer;
                };
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                AudioEntity.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                AudioEntity.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.com.opensource.svga.AudioEntity();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                AudioEntity.decodeDelimited = function decodeDelimited(reader) {
                    if (!(reader instanceof $Reader))
                        reader = new $Reader(reader);
                    return this.decode(reader, reader.uint32());
                };
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                AudioEntity.verify = function verify(message) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (message.audioKey != null && message.hasOwnProperty("audioKey"))
                        if (!$util.isString(message.audioKey))
                            return "audioKey: string expected";
                 ...
                 * @returns {com.opensource.svga.AudioEntity} AudioEntity
                 */
                AudioEntity.fromObject = function fromObject(object) {
                    if (object instanceof $root.com.opensource.svga.AudioEntity)
                        return object;
                    let message = new $root.com.opensource.svga.AudioEntity();
                    if (object.audioKey != null)
                        message.audioKey = String(object.audioKey);
                 ...
                 * @memberof com.opensource.svga.AudioEntity
                 * @static
                 * @param {com.opensource.svga.AudioEntity} message AudioEntity
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                AudioEntity.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                    ...
                    if (message.audioKey != null && message.hasOwnProperty("audioKey"))
                        object.audioKey = message.audioKey;
                    if (message.startFrame != null && message.hasOwnProperty("startFrame"))
                 ...
                 * @returns {Object.<string,*>} JSON object
                 */
                AudioEntity.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            svga.MovieEntity = (function() {
                ...
                MovieEntity.encode = function encode(message, writer) {
                    ...
                    if (message.audios != null && message.audios.length)
                        for (let i = 0; i < message.audios.length; ++i)
                            $root.com.opensource.svga.AudioEntity.encode(message.audios[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                    return writer;
                };
                    ...
                    while (reader.pos < end) {
                        ...
                        case 5: {
                                if (!(message.audios && message.audios.length))
                                    message.audios = [];
                                message.audios.push($root.com.opensource.svga.AudioEntity.decode(reader, reader.uint32()));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                MovieEntity.verify = function verify(message) {
                    ...
                    if (message.audios != null && message.hasOwnProperty("audios")) {
                        if (!Array.isArray(message.audios))
                            return "audios: array expected";
                        for (let i = 0; i < message.audios.length; ++i) {
                            let error = $root.com.opensource.svga.AudioEntity.verify(message.audios[i]);
                            if (error)
                                return "audios." + error;
                        }
                    }
                ...
                MovieEntity.fromObject = function fromObject(object) {
                    ...
                    if (object.audios) {
                        if (!Array.isArray(object.audios))
                            throw TypeError(".com.opensource.svga.MovieEntity.audios: array expected");
                        message.audios = [];
                        for (let i = 0; i < object.audios.length; ++i) {
                            if (typeof object.audios[i] !== "object")
                                throw TypeError(".com.opensource.svga.MovieEntity.audios: object expected");
                            message.audios[i] = $root.com.opensource.svga.AudioEntity.fromObject(object.audios[i]);
                        }
                    }
                    return message;
                };
                ...
                MovieEntity.toObject = function toObject(message, options) {
                    ...
                    if (message.audios && message.audios.length) {
                        object.audios = [];
                        for (let j = 0; j < message.audios.length; ++j)
                            object.audios[j] = $root.com.opensource.svga.AudioEntity.toObject(message.audios[j], options);
                    }
                    return object;
                };
